report 50011 "Albarán Venta Ecoquimic New"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/layout/Albarán Venta Ecoquimic New.rdlc';
        ...
        dataitem("Sales Header"; "Sales Shipment Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                begin
                    ...
                    TImporte := VATAmountLine.GetTotalLineAmount(false, "Sales Header"."Currency Code");
                    SalesHeader.Delete;
