report 50022 "Factura Venta Ecoquimic Pdf"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/layout/Factura Venta Ecoquimic Pdf.rdlc';
        ...
        dataitem("Sales Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(YourRef_SalesHeader; YourRef)
                    {
                    }
                    ...
                    column(PorIva2; PorIva2)
                    {
                    }
                    column(ImporteIva2; ImporteIva2)
                    {
                    }
                    column(PorRe2; PorRe2)
                    {
                    }
                    column(ImporteRe2; ImporteRe2)
                    {
                    }
            ...
            begin
                ...
                ReferenceText := "Sales Header"."Order No.";
                ...
                if "Sales Header"."Sell-to Customer No." = '900000' then
                    FormatAddr.SalesInvSellTo(CustAddr, "Sales Header")
                else
                ...
                if "Sales Header"."Sell-to Customer No." = '900000' then
                    CustAddr[3] := "Sales Header"."Sell-to Address" else
                    CustAddr[3] := "Sales Header"."Bill-to Address";
                if "Sales Header"."Sell-to Customer No." = '900000' then
                    CustAddr[4] := "Sales Header"."Sell-to Post Code" else
                    CustAddr[4] := "Sales Header"."Bill-to Post Code";
                if "Sales Header"."Sell-to Customer No." = '900000' then
                    CustAddr[5] := "Sales Header"."Sell-to City" else
                ...
                if VATAmountLine.FindFirst then begin
                    ...
                    VATAmountLine.SetRange("VAT %", PorIva);
                ...
                VATAmountLine.SetFilter("VAT %", '<>%1', PorIva);
                if VATAmountLine.FindFirst then
                    repeat
                        Base2 += VATAmountLine."VAT Base";
                        PorIva2 := VATAmountLine."VAT %";
                        PorRe2 := VATAmountLine."EC %";
                        ImporteIva2 += VATAmountLine."VAT Amount";
                        ImporteRe2 += VATAmountLine."EC Amount";
                    until VATAmountLine.Next = 0;
                VATAmountLine.Reset;
    ...
    var
        ...
        SalesCountPrinted: Codeunit "Sales Inv.-Printed";
        ...
        Bultos: Decimal;
        ServiceShipmentBuffer: Record "Sales Shipment Buffer" temporary;
        Desc: Text[250];
        Albaran: Text[20];
        TotAlb: Decimal;
        Linea: Integer;
