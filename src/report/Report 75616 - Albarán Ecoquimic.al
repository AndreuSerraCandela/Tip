report 50016 "Albarán Ecoquimic"
{
    ...
    // Adapta Andreu
    // -001 19/06/17 cobon: Ocultar descripción referencia cruzada
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/layout/Albarán Ecoquimic.rdlc';
    ...
    dataset
    {
        ...
        dataitem("Sales Header"; "Sales Shipment Header")
        {
            ...
            column(ShipmentMethodDescription; TipoFactura)
            {
            }
            column(PaymentMethodDescription; PaymentMethod.Description)
            {
            }
            column(DocType_SalesHeader; 'Albarán')
            {
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(YourRef_SalesHeader; TipoFac)
                    {
                    }
                    ...
                    column(envioaNombre; CustAddr[2])
                    {
                    }
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        dataitem(DimensionLoop2; "Integer")
                        {
                            ...
                            begin
                                ...
                                //         if Bomc."Excluir ADR" then CurrReport.Skip;
                                //     if (SalesLine."Gross Weight" = 0) then begin
                                //         SalesLine."Gross Weight" := 1;
                                //         if DimensionValue.Get('TIPOENVASE', Item."Tipo de envase") then
                                //             SalesLine."Gross Weight" := DimensionValue.Peso;
            ...
            begin
                ...
                if not ShowShippingAddr then Clear(ShipToAddr);
                //-001
                g_txtPorCuentaDe := '';
