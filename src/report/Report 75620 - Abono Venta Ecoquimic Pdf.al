report 50020 "Abono Venta Ecoquimic Pdf"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/layout/Abono Venta Ecoquimic Pdf.rdlc';
        ...
        dataitem("Sales Header"; "Sales Cr.Memo Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(YourRef_SalesHeader; YourRef_SalesHeader)
                    {
                    }
                    ...
                    dataitem("Sales Line"; "Sales Cr.Memo Line")
                    {
                        ...
                        begin
                            ...
                            if SalesLine.Type = 0 then Linea := SalesLine."Line No." - 1;
                            //+005
                            if (SalesLine."Return Receipt No." <> Albaran) and (SalesLine."Return Receipt No." <> '') and (TotAlb <> 0) then begin
                                //-005
                                AlbaranAnterior := Albaran;
                                //+005
                                Albaran := SalesLine."Return Receipt No.";
                            ...
                            if SalesLine."Return Receipt No." <> '' then begin
                                Albaran := SalesLine."Return Receipt No.";
                                rcabalbaran.Reset;
                                if not (rcabalbaran.Get(SalesLine."Return Receipt No.")) then begin
                                    rcabalbaran.Init;
                                    rcabalbaran."No." := SalesLine."Return Receipt No.";
            ...
            begin
                ...
                if "Your Reference" = '' then
                    ...
                    YourRef_SalesHeader := FieldCaption("Your Reference");
                ReferenceText := '';
                ...
                FormatAddr.SalesCrMemoBillTo(CustAddr, "Sales Header");
                ...
                FormatAddr.SalesCrMemoShipTo(ShipToAddr, CustAddr, "Sales Header");
    ...
    var
        ...
        SalesLine: Record "Sales Cr.Memo Line" temporary;
        ...
        TotAlb: Decimal;
        Linea: Integer;
        rcabalbaran: Record "Return Receipt Header";
        Linea2: Integer;
        g_txtDto: Text;
